...
class App extends Component {
    ...
    getCurrentParticipants() {
        this.getParticipants(apis.tournaments).then(res => {
            let participants = [];
            res.forEach(p => {
    ...
    getParticipants(api, tournamentName) {
        ...
        const url = `https://cors-anywhere.herokuapp.com/https://api.challonge.com/v1/${api}/${this.tournamentName}/participants.json?api_key=uszU4emqNBWI2PGszGWxvKjMFTU8QwSqMfef5zrf`;
